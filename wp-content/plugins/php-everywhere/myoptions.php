...
<h1><?php _e('User role management', 'php-everywhere')?></h1>
<p><?php _e('Who can modify the PHP in posts and pages?', 'php-everywhere')?></p>
<form method="post">
...
<h3><?php _e('Multiple PHP instances', 'php-everywhere')?></h3>
