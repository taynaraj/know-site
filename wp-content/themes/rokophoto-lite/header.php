		...
		<div class="container">
			<div class="align-vertical">
				<div class="navbar-header page-scroll">
					...
					if ( ! empty( $logourl ) ) {
						echo '<a class="navbar-brand navbar-brand-logo" href="' . esc_url( home_url( '/' ) ) . '"><div class="background-logo"><img src="' .get_template_directory_uri() . '/img/corte-logo.svg' . '" alt="logo"></div><img src="' . $logourl . '" alt="logo"></a>';
